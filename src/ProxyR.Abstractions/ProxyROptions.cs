...
{
    /// <summary>
    /// Represents the options for a ProxyR request.
    /// </summary>
    public class ProxyROptions
    {
        ...
        /// </summary>
        public ICollection<string> RequiredParameterNames { get; set; } = new HashSet<string>(StringComparer.InvariantCultureIgnoreCase);
